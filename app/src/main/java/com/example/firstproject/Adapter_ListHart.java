...
public class Adapter_ListHart extends RecyclerView.Adapter<Adapter_ListHart.CustomViewHolder> {
    ...
    ArrayList<Boolean> 관심여부복사본 = (ArrayList<Boolean>) 관심여부.clone();
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        //true 값이 있는 위치 값
        int true_위치 = 관심여부복사본.indexOf(true);
        관심여부복사본.set(true_위치,false);
        ...
        //하트 초기화
        boolean 관심_초기화 = 관심여부.get(true_위치);
    ...
    public int getItemCount() {
        return Collections.frequency(관심여부,true);
    }
